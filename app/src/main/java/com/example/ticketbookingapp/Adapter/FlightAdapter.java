...
import com.example.ticketbookingapp.Activity.SeatActivity;
import com.example.ticketbookingapp.databinding.ViewholderFlightBinding;
...
public class FlightAdapter extends RecyclerView.Adapter<FlightAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull FlightAdapter.Viewholder holder, int position) {
        ...
        holder.binding.tv9.setText(flight.getArriveTime());
